  ...
  */
  ...
  public void autonomousPeriodic() {
    ...
    case 1:
      ...
      //forward for 7.5 ft
      drive.calculateAutonomousDrive(m_autoTimerCurrent, 0, 5 , 1.0, 1.0, -0.5);

      //drive in a circle with (radius (3ft), speed (-0.5))
      drive.calculateAutonomousCircle(m_autoTimerCurrent, 5, 5, -0.5, 3, distanceBtwnWheels, true);

      //forward for 9 ft
      drive.calculateAutonomousDrive(m_autoTimerCurrent, 10, 5 , 1.0, 1.0, -0.5);

      //drive in a circle with (radius (3ft), speed (-0.5))
      drive.calculateAutonomousCircle(m_autoTimerCurrent, 15, 5, -0.5, 3, distanceBtwnWheels, false);

      //forward for 7 ft
      drive.calculateAutonomousDrive(m_autoTimerCurrent, 20, 5 , 1.0, 1.0, -0.5);

      //drive in a circle with (radius (3ft), speed (-0.5))
      drive.calculateAutonomousCircle(m_autoTimerCurrent, 15, 5, -0.5, 3, distanceBtwnWheels, false);

      //forward for 20 ft
      drive.calculateAutonomousDrive(m_autoTimerCurrent, 30, 5 , 1.0, 1.0, -0.5);
    ...
    case 2:
      ...
      drive.calculateAutonomousCircle(m_autoTimerCurrent, 0, 5, -0.5, 0, distanceBtwnWheels, false);

      //forward for 7 ft
      drive.calculateAutonomousDrive(m_autoTimerCurrent, 5, 5, 1.0, 1.0, -0.5);

      //drive in a circle with (radius (5ft), speed (-0.5))
      drive.calculateAutonomousCircle(m_autoTimerCurrent, 10, 5, -0.5, 5, distanceBtwnWheels, true);

      //forward for 7 ft
      drive.calculateAutonomousDrive(m_autoTimerCurrent, 15, 5, 1.0, 1.0, -0.5);

      //drive in a circle with (radius (2.5ft), speed (-0.5))
      drive.calculateAutonomousCircle(m_autoTimerCurrent, 20, 5, -0.5, 2.5, distanceBtwnWheels, false);

      //forward for 7 ft
      drive.calculateAutonomousDrive(m_autoTimerCurrent, 25, 5, 1.0, 1.0, -0.5);

      //drive in a circle with (radius (5ft), speed (-0.5))
      drive.calculateAutonomousCircle(m_autoTimerCurrent, 30, 5, -0.5, 5, distanceBtwnWheels, true);

      //forward for 7 ft
      drive.calculateAutonomousDrive(m_autoTimerCurrent, 35, 5, 1.0, 1.0, -0.5);

      //drive in a circle with (radius (0ft), speed (-0.5))
      drive.calculateAutonomousCircle(m_autoTimerCurrent, 40, 5, -0.5, 5, distanceBtwnWheels, false);
      break;
    case 3:
      //Turn Left to face cone
      drive.calculateAutonomousCircle(m_autoTimerCurrent, 0, 1, -0.5, 3, distanceBtwnWheels, false);

      //Drive into cone A3
      drive.calculateAutonomousDrive(m_autoTimerCurrent, 1, 5, 1.0, 1.0, -0.5);

      //Turn Left to face back away from cone while heading backwards
      drive.calculateAutonomousCircle(m_autoTimerCurrent, 6, 2, -0.5, 5, distanceBtwnWheels, false);

      //Drive Forward
      drive.calculateAutonomousDrive(m_autoTimerCurrent, 8, 3, -1.0, -1.0, -0.5);

      //Circle Around D5 CCW
      drive.calculateAutonomousCircle(m_autoTimerCurrent, 11, 5, 0.5, 5, distanceBtwnWheels, false);

      //Head into cone A6
      drive.calculateAutonomousDrive(m_autoTimerCurrent, 16, 5, -1.0, -1.0, -0.5);

      //Turn Left to face back away from cone while heading backwards
      drive.calculateAutonomousCircle(m_autoTimerCurrent, 21, 2, -0.5, 5, distanceBtwnWheels, false);

      //Drive Forward
      drive.calculateAutonomousDrive(m_autoTimerCurrent, 23, 3, 1.0, 1.0, -0.5);

      //Turn around D7 CCW
      drive.calculateAutonomousCircle(m_autoTimerCurrent, 26, 2, 0.5, 5, distanceBtwnWheels, false);

      //Head forwards past D8
      drive.calculateAutonomousDrive(m_autoTimerCurrent, 28, 4, 1.0, 1.0, -0.5);

      //Turn around D8 CCW
      drive.calculateAutonomousCircle(m_autoTimerCurrent, 30, 2, 0.5, 5, distanceBtwnWheels, false);

      //Head into cone A9
      drive.calculateAutonomousDrive(m_autoTimerCurrent, 32, 5, 1.0, 1.0, -0.5);

      //Circle into finish zone
      drive.calculateAutonomousCircle(m_autoTimerCurrent, 37, 4, -0.5, 15, distanceBtwnWheels, false);
